          ...
          <div class="col-lg-12 col-md-12">
               <div class="card">
                    <div class="card-header hc-header-outer">
                         ...
                         <a href="{{ route('patient.manage') }}" class="btn btn-sm btn-manage">Manage</a>
                    </div>
                    <div class="card-body">
                         <form class="row g-3" action="{{ route('patient.store') }}" method="POST">
                              ...
                              <div class="col-lg-12 col-md-12">
                                   ...
                                   <textarea class="form-control" name="address" rows="5" placeholder="Enter patient address">{{ old('address') }}</textarea>
