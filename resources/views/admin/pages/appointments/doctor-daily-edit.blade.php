          ...
          <div class="col-lg-12 col-md-12 mb-25">
               <div class="card">
                    <div class="card-header hc-header-outer">
                         ...
                         <a href="{{ route('appointment.own.daily') }}" class="btn btn-sm btn-manage">Manage</a>
                    </div>
                    <div class="card-body">
                         <form class="row g-3" action="{{ route('appointment.own.daily.update', $appointment->id) }}" method="POST">
                              @csrf
                              <div class="col-12">
