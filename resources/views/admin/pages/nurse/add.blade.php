    ...
    <div class="container-fluid mt-3">
          <div class="col-lg-12 col-md-12 mb-25">
               <div class="card">
                    ...
                    <div class="card-body">
                         <form class="row g-3" action="{{ route('nurse.store') }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              <div class="col-lg-4 col-md-4 col-sm-12">
                                   <label for="firstName" class="form-label">First name <span class="text-danger">*</span></label>
                                   <input type="text" class="form-control" name="first_name" value="{{ old('first_name') }}" placeholder="eg: Rahima"/>
                                   <span class="text-danger">{{ $errors->has('first_name') ? $errors->first('first_name') : ' ' }}</span>
                              </div>
                              <div class="col-lg-4 col-md-4 col-sm-12">
                                   <label for="lastName" class="form-label">Last name </label>
                                   <input type="text" class="form-control" name="last_name" value="{{ old('last_name') }}" placeholder="eg: aktar"/>
                              </div>

                              <div class="col-lg-4 col-md-4 col-sm-12">
                                   <label for="blood_group" class="form-label">Blood group <span class="text-danger">*</span></label>
                                   <input type="text" class="form-control" name="blood_group" value="{{ old('blood_group') }}" placeholder="eg: o+"/>
                                   <span class="text-danger">{{ $errors->has('blood_group') ? $errors->first('blood_group') : ' ' }}</span>
                              </div>

                              <div class="col-lg-6 col-md-6 col-sm-12">
                                   <label for="email" class="form-label">Email <span class="text-danger">*</span></label>
                                   <input type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="eg: nurse@info.com"/>
                              ...
                              <div class="col-lg-4 col-md-4 col-sm-12">
                                   ...
                                   <input type="date" class="form-control" name="dob" value="{{ old('dob') }}" placeholder="eg: dd/mm/YYYY"/>
                              ...
                              <div class="col-lg-4 col-md-4 col-sm-12">
                                   ...
                                   <input type="date" class="form-control" name="join_date" value="{{ old('join_date') }}" placeholder="eg: dd/mm/YYYY"/>
                              ...
                              <div class="col-md-6">
                                   ...
                                   <input type="text" class="form-control" name="experience" value="{{ old('experience') }}" placeholder="Enter work experience..."/>
