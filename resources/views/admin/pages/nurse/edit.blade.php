          ...
          <div class="col-lg-12 col-md-12 mb-25">
               <div class="card">
                    <div class="card-header hc-header-outer">
                         ...
                         <a href="{{ route('nurse.manage') }}" class="btn btn-sm btn-manage">Manage</a>
                    </div>
                    <div class="card-body">
                         <form class="row g-3" action="{{ route('nurse.update', $nurse->id) }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              <div class="col-lg-4 col-md-4 col-sm-12">
                                   <label for="firstName" class="form-label">First name <span class="text-danger">*</span></label>
                                   <input type="text" class="form-control" name="first_name" value="{{ $nurse->first_name ?? old('first_name') }}" placeholder="eg: Rahima"/>
                                   <span class="text-danger">{{ $errors->has('first_name') ? $errors->first('first_name') : ' ' }}</span>
                              </div>
                              <div class="col-lg-4 col-md-4 col-sm-12">
                                   <label for="lastName" class="form-label">Last name </label>
                                   <input type="text" class="form-control" name="last_name" value="{{ $nurse->last_name ?? old('last_name') }}" placeholder="eg: aktar"/>
                              </div>

                              <div class="col-lg-4 col-md-4 col-sm-12">
                                   <label for="blood_group" class="form-label">Blood group <span class="text-danger">*</span></label>
                                   <input type="text" class="form-control" name="blood_group" value="{{ $nurse->blood_group ?? old('blood_group') }}" placeholder="eg: o+"/>
                                   <span class="text-danger">{{ $errors->has('blood_group') ? $errors->first('blood_group') : ' ' }}</span>
                              </div>

                              <div class="col-lg-6 col-md-6 col-sm-12">
                                   <label for="email" class="form-label">Email <span class="text-danger">*</span></label>
                                   <input type="email" class="form-control" name="email" value="{{ $nurse->email ?? old('email') }}" placeholder="eg: nurse@info.com"/>
                                   <span class="text-danger">{{ $errors->has('email') ? $errors->first('email') : ' ' }}</span>
                              </div>
                              <div class="col-lg-6 col-md-6 col-sm-12">
                                   <label for="phone" class="form-label">Phone <span class="text-danger">*</span></label>
                                   <input type="tel" class="form-control" name="phone" value="{{ $nurse->phone ?? old('phone') }}" placeholder="eg: 01309608232"/>
                              ...
                              <div class="col-lg-4 col-md-4 col-sm-12">
                                   ...
                                   <input type="date" class="form-control" name="dob" value="{{ $nurse->dob ?? old('dob') }}" placeholder="eg: dd/mm/YYYY"/>
                              ...
                              <div class="col-lg-4 col-md-4 col-sm-12">
                                   ...
                                   <input type="date" class="form-control" name="join_date" value="{{ $nurse->join_date ?? old('join_date') }}" placeholder="eg: dd/mm/YYYY"/>
                              ...
                              <div class="col-md-6">
                                   ...
                                   <input type="text" class="form-control" name="qualification" value="{{ $nurse->qualification ?? old('qualification') }}" placeholder="Enter qualification"/>
                              ...
                              <div class="col-md-6">
                                   ...
                                   <input type="text" class="form-control" name="experience" value="{{ $nurse->experience ?? old('experience') }}" placeholder="Enter work experience..."/>
                              ...
                              <div class="col-md-12">
                                   ...
                                   <textarea class="form-control" name="address" rows="4" placeholder="Enter present address">{{ $nurse->address ?? old('address') }}</textarea>
                              ...
                              <div class="col-md-6">
                                   ...
                                   @if($nurse->avatar)
                                   <img src="{{ asset($nurse->avatar) }}" class="avatar-size" />
                                   @else
