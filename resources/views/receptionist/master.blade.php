...
<body>
    <section class="main-wrapper">
            ...
            <div class="position-sticky bg-dark-subtle bottom-0 d-flex align-items-center justify-content-between border-top">
                <div class="dropup">
                    <div class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                        <img class="img-fluid brand-sm-logo" src="{{ auth()->guard('receptionist')->user()->avatar }}" alt="profile picture">
                        {{ auth()->guard('receptionist')->user()->full_name }}
                        <ul class="dropdown-menu text-center">
                            <li>Settings</li>
                            <li>Profile</li>
                            <li>
                                <a href="{{ route('receptionist.logout') }}"onclick="event.preventDefault();
                                document.getElementById('receptionist-logout-form').submit();">Logout</a>
 
                                 <form id="receptionist-logout-form" action="{{ route('receptionist.logout') }}" method="POST" class="d-none">
                                     @csrf
                                 </form>
                            </li>
                        </ul>
        ...
        <div class="wrapper">
            ...
            <footer>
                <p class="copyright-text position-fixed bottom-0 p-2 mb-0 text-center border-top">&copy; Made with 💖 by <a href="#">Devscodebd</a>. All rights reserved</p>
            </footer>
        </div>
